...
for epoch in range(epochs):
    u1_num = np.power(init_parameters[2], np.sum(results, 1)) * np.power(1 - init_parameters[2],
                                                                         M - np.sum(results, 1)) * init_parameters[0]
    den = np.power(init_parameters[2], np.sum(results, 1)) * np.power(1 - init_parameters[2],
                                                                      M - np.sum(results, 1)) * init_parameters[0] \
          + np.power(init_parameters[3], np.sum(results, 1)) * np.power(1 - init_parameters[3],
                                                                        M - np.sum(results, 1)) * init_parameters[1] \
          + np.power(init_parameters[4], np.sum(results, 1)) * np.power(1 - init_parameters[4],
                                                                        M - np.sum(results, 1)) * (
